/* autogenerated by Processing revision 1297 on 2025-03-22 */
...
public class graph_app extends PApplet {
...
public void drawGraph() {
  ...
  visibleMin -= padding;
  visibleMax += padding;
  if (visibleMin < 0) visibleMin = -padding * 1.5f;
...
public void drawTooltip(int startIndex, int endIndex, float visibleMin, float visibleMax, float visibleCount) {
...
public void drawAxes(float visibleMin, float visibleMax, float scrollOffset, float visibleCount) {
  stroke(180);
  fill(0);
  textSize(12);
...
public void keyPressed() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "graph_app" };
    if (passedArgs != null) {
